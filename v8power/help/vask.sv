...
Fr†ga efter textinmatning.
    ...
    /T fil ID   Sl† upp ID i fil och behandla den som en kommandorad-
                sparameter.
                Ytterligare parametrar som f”ljer p† denna flagga
                anv„nds f”r att populera variablerna %1-%9 i textstr„ngen.

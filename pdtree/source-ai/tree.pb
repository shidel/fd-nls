...
1.1:\n
# main [Set 1] 
1.2:Listagem de CAMINHO de diret¢rio\n
# Must include %s for label 
1.3:Listagem de CAMINHO de diret¢rio para o Volume %s\n
# Must include %s for serial #  
1.4:O n£mero de s‚rie do volume ‚ %s\n
1.5:NÆo existem subdiret¢rios\n\n
1.6: --- Pressione qualquer tecla para continuar ---\n
# showUsage [Set 2] 
2.1:Exibe graficamente a estrutura de diret¢rios da unidade ou caminho.\n
...
2.4:   %c%c   Usa ASCII em vez de caracteres estendidos.\n
# showInvalidUsage [Set 3] 
# Must include the %s for option given.
3.1:Parƒmetro inv lido - %s\n
# The %c will be replaced with the primary switch (default is /)
3.2:Use TREE %c? para obter ajuda.\n
#showTooManyOptions
3.3:Excesso de parƒmetros - %s\n
...
7.1:Erro: O caminho especificado excede o buffer m ximo = %u bytes\n
# showOutOfMemory
